...
class Attention(nn.Module):
    def __init__(self, dim, heads = 8, dim_head = 64, attention='softmax'):
        super().__init__()
...
class Transformer(nn.Module):
    def __init__(self, dim, depth, heads, dim_head, mlp_dim,attention='softmax'):
        super().__init__()
        self.layers = nn.ModuleList([])
        for _ in range(depth):
            self.layers.append(nn.ModuleList([
                Attention(dim, heads = heads, dim_head = dim_head,attention=attention),
