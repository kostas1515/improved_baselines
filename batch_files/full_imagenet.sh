...
torchrun --nproc_per_node=4 train.py --dset_name=ImageNet --model cb_resnet152 --output-dir ../experiments/cb_r152_inet_e100_aaug_gumbel_se -b 64 --lr-scheduler cosineannealinglr --lr-warmup-epochs 3 --lr-warmup-method linear --lr 0.256 --epochs 100 --mixup 0.2 --wd 6.103515625e-05 --auto-augment imagenet --momentum 0.875 --use_gumbel_se  --amp --train-crop-size 192 --val-resize-size 232