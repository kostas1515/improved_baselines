...
torchrun --nproc_per_node=4 train.py --model se_resnext50_32x4d --batch-size 256 --lr 0.5 --lr-scheduler cosineannealinglr --lr-warmup-epochs 5 --lr-warmup-method linear --auto-augment imagenet --epochs 600 --random-erase 0.1 --weight-decay 0.0001 --norm-weight-decay 0.0 --label-smoothing 0.1 --mixup-alpha 0.2 --cutmix-alpha 1.0 --train-crop-size 176 --val-resize-size 232 --ra-sampler --ra-reps 4 --dset_name=imagenet_lt --output-dir ../experiments/x50_ilt_ce_mean_gumbel_se_wd1e-4_b256_e600_aa_re_ra --classif_norm cosine --use_gumbel_se